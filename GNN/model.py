...
class GNN_layer(nn.Module):
    ...
    def __init__(
        ...
        self.X1_l1, self.X1_l2, self.X2_l1, self.X2_l2 = nn.ModuleList(
            [nn.Linear(x_in_channels, x_out_channels, bias=False) for _ in range(4)]
        )
        ...
        self.out_transform = nn.Linear(A_out_channels * x_out_channels, x_out_channels, bias=False)
