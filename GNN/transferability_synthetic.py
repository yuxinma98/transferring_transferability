...
if __name__ == "__main__":
    ...
    M = args.reference_graph_size
    log_n_range = args.log_n_range
    d = 5
    ...
    model = GNN(in_channels=d, out_channels=1, hidden_channels=5, num_layers=3, model=args.model)
    model.eval()
    ...
    plt.xscale("log")
    plt.yscale("log")
    plt.savefig(os.path.join(log_dir, f"transferability_{graph_model}_{args.model}.png"))
